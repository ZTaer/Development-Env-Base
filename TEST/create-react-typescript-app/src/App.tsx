...
const App = (): ReactElement => {
	...
	const getActiveCloneCommand = () => {
		let result = cloneCommands.filter((command) => command.isActive)[0]
			.command;
			...
			<section className="wrapper">
				...
				<section className="installation">
					...
					<section
						...
						onClick={() =>
							setIsInputProjectShow(!isInputProjectShow)
						}
						aria-hidden="true"
					>
						{!isInputProjectShow ? 'Show ' : 'Close '}Custom Project
						Name
					</section>
					{isInputProjectShow && (
					...
					{isAutoInstallEnable && isInputProjectShow ? (
						...
						<section className="code-block">
							<code
								onClick={() =>
									writeClipboard(getActiveCloneCommand())
								}
								aria-hidden="true"
							>
